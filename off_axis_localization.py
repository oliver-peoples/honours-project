...
def main() -> None:
    ...
    illumination_structures = [
        ...
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=0),
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=np.pi/10),
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=2*np.pi/10),
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=3*np.pi/10),
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=4*np.pi/10),
        # GaussHermite(0, 3, 1., 0.5, center=[0.0,0.0], rotation=5*np.pi/10),
