...
def loadAsciiSpectrum(path: str):
    ...
    integration_time = max(*[float(integration_time) for integration_time in line.split(' ')])
    ...
    return bin_counts, mca_coefficients, epoch, integration_time