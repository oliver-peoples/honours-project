...
int main()
{
    ...
    saveIndexes("multicore-localization/g2_capable_indexes.csv", G2_CAPABLE_IDX);
    ...
    saveMeasurements("multicore-localization/g1_g2_measurements.csv", multicore_measure);
